...
#[derive(Deserialize)]
pub struct ParamsForCreate<B> {
  data: B,
}

#[derive(Deserialize)]
pub struct ParamsForUpdate<B> {
  id: i64,
  data: B,
}
...
async fn rpc_handler(
  ...
  // Create the RPC Info to be set to response.extensions.
...
/// RPC basic information holding the id and the method of the request
#[derive(Debug)]
pub struct RpcInfo {
  pub id: Option<Value>,
  pub method: String,
